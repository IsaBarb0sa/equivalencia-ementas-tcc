class InstituicaoJaExisteError(Exception):
    pass


class InstituicaoNaoEncontradaError(Exception):
    pass


class CursoJaExisteError(Exception):
    pass
...
class MatrizCurricularJaExisteError(Exception):
    pass


class MatrizCurricularNaoEncontradaError(Exception):
    pass


class DisciplinaJaVinculadaError(Exception):
    pass


class MatrizCurricularNaoEditavelError(Exception):
    pass
